...
int Test_H264_Decoder_Line_Buffer(int argc, char **argv)
{
	...
	LOG_MSG(LOG_TRACE, "Test_H264_Decoder_Line_Buffer", "\t<STREAMINFO> width=%d   height=%d    buf_width=%d    buf_height=%d.\n", 	\
...
int Test_MPEG4_Decoder_Line_Buffer(int argc, char **argv)
{
	...
	LOG_MSG(LOG_TRACE, "Test_MPEG4_Decoder_Line_Buffer", "\t<STREAMINFO> width=%d   height=%d    buf_width=%d    buf_height=%d.\n",	\
		stream_info.width, stream_info.height, stream_info.buf_width, stream_info.buf_height);
...
int Test_H263_Decoder_Line_Buffer(int argc, char **argv)
{
	...
	LOG_MSG(LOG_TRACE, "Test_H263_Decoder_Line_Buffer", "\t<STREAMINFO> width=%d   height=%d    buf_width=%d    buf_height=%d.\n",	\
		stream_info.width, stream_info.height, stream_info.buf_width, stream_info.buf_height);
...
int Test_VC1_Decoder_Line_Buffer(int argc, char **argv)
{
	...
	LOG_MSG(LOG_TRACE, "Test_VC1_Decoder_Line_Buffer", "\t<STREAMINFO> width=%d   height=%d    buf_width=%d    buf_height=%d.\n",	\
		stream_info.width, stream_info.height, stream_info.buf_width, stream_info.buf_height);
